...
{
    [TestClass]
    public class GeminiXliffTests : TestBase
    {
        [TestMethod]
        public async Task XLIFFScoreReturnsValues()
        {
            ...
            {
                File = new Blackbird.Applications.Sdk.Common.Files.FileReference {Name= "test.xliff" },
            ...
            var input3 = new PromptRequest { ModelEndpoint= "gemini-2.5-pro-preview-03-25" };
        ...
        public async Task XLIFFProcessReturnsValues()
        {
            ...
            var inputFile = new TranslateXliffRequest { File = new Blackbird.Applications.Sdk.Common.Files.FileReference { Name= "test.xliff" }, AIModel = "gemini-1.5-pro-002"};
