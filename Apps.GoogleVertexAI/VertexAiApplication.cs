using Apps.GoogleVertexAI.Connections.OAuth2;
...
public class VertexAiApplication : BaseInvocable, IApplication
{
    private readonly Dictionary<Type, object> _typesInstances;

    public VertexAiApplication(InvocationContext invocationContext) : base(invocationContext)
    {
